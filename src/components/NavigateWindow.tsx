              ...
              <span ref={nodeRef}>
                <span className='fadem'>
                 { result == '' ? ( 
                   <>
                    <span className="box">
                      <span className='nose' onClick={() => Elref.current?.click()} ><span className='imgview2' style={{ width: '40px', height: '40px', color: 'white'}}><FontAwesomeIcon className='icon__fa_upload_'icon={faUpload as IconDefinition} /></span><span className='bnp_up'><span className='input__1'><b>INPORT FILE</b><span className='input_on'>Load font file(support .woff .otf .ttf file)😄</span></span></span></span>
